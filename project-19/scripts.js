...
function setTime() {
    ...
    let secondsScaled = (scale(seconds, 0, 59, 0, 360)) + secondsLap * 360;
    let minutesScaled = (scale(minutes, 0, 59, 0, 360)) + minutesLap * 360;
    let hoursScaled = (scale(hoursForClock, 0, 59, 0, 360)) + hoursLap * 360;
